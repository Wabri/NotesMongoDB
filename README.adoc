...
https://docs.mongodb.com/manual/tutorial/install-mongodb-on-ubuntu/#install-mongodb-community-edition-using-deb-packages[Install Mongo on Ubuntu]

https://www.mongodb.com/download-center/community[MongoDB community]
...
* *String* e.g. ``key'': ``some strings''
* *Number* e.g. ``key'': 1234
* *Boolean* e.g. ``key'': false
* *Object* e.g. ``key'': \{``other_key'': ``some string value''}
* *Array* e.g. ``key'': [``string'', ``other string'']
