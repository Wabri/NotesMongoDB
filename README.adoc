...
https://docs.mongodb.com/manual/reference/limits/[limits]
...
_all of this types is in json format, for the BSON format see this: https://docs.mongodb.com/manual/reference/bson-types/[bson-types]
